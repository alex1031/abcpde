...
#         # Plot alpha and beta
#         sns.histplot(ax=ax_alpha, data=alpha, stat="probability", element="step", fill=True, label=DISTANCES[i - 2], binwidth=0.1, alpha=0.3)
#         sns.histplot(ax=ax_beta, data=beta, stat="probability", element="step", fill=True, label=DISTANCES[i - 2], binwidth=0.1, alpha=0.3)
